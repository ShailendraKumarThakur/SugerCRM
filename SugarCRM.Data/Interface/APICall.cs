...
namespace SugarCRM.Data.Interface
{
    public class APICall
    {
        ...
        public async Task<object> ProcessRequestAsync()
        {
            ...
            if (retVal is AbstractSugarCRMData)
            {
                ((AbstractSugarCRMData)retVal).QuotaResponseRequestQuota = IntegrationResponse.LimitRequestsQuota;
                ((AbstractSugarCRMData)retVal).QuotaResponseRequestsLeft = IntegrationResponse.LimitRequestsLeft;
                ((AbstractSugarCRMData)retVal).QuotaResponseResetMS = IntegrationResponse.LimitTimeResetMs;
                ((AbstractSugarCRMData)retVal).QuotaResponseWindowMS = IntegrationResponse.LimitTimeWindowMs;
            }
