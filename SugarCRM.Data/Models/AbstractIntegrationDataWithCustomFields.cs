...
namespace SugarCRM.DataModels
{
    ...
    // If you perform inheritence of AbstractSugarCRMDataWithCustomFields, you must develop handlers in CustomFields.cs
    public abstract class AbstractSugarCRMDataWithCustomFields : AbstractSugarCRMData
    {
        [JsonIgnore]
